...
<header>
    ...
    <section style="max-width:70%;margin-left:15%">
       <div class="head">
        <h1 style="font-size:40px;margin-bottom:3%;padding-top: 1rem;">West Side</h1>
       </div>
       <div>
        <span style="color:red;font-size:22px">22,20,000 INR</span>
       </div>
       <div style="padding-top:2rem">
        <img src="img/i1.jpg" height="600px" style="border-radius:2rem 2rem 2rem 2rem">
       </div>
       <div>
      ...
      <div style="width:60%;coolor:2B2B2B;;padding-top:1.5rem;font-size:15px;justify:content">
        <p>A 4 BHK house is a four-bedroom, two-bathroom house. It is typically the smallest type of house,
             but it is still a comfortable and spacious home for a small family or a couple. The bedrooms are typically of a good size, 
             and there is enough space for a living room, a dining room, and a kitchen.</p>
      </div>
<style>
    .class span{
        font-weight:bold;
      ...
      <div style="padding-top:4rem" class="class">
            ...
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="28.153 28.153 143.693 143.693" 
            viewBox="28.153 28.153 143.693 143.693" height="30" width="30" xmlns="http://www.w3.org/2000/svg"
             data-type="color" role="presentation" aria-hidden="true"><defs><style>#comp-jpqo4bqu svg [data-color="1"] {fill: #B2BECF;}</style></defs>
    <g>
        <path d="M28.153 28.153v143.693h143.693V28.153H28.153zm135.694 8v44.339H36.153V36.153h127.694zM36.153 163.847V88.492h127.693v75.354H36.153z"
        ...
        <path d="M156.339 41.723h-52.585v31.262h52.585V41.723zm-8 23.261h-36.585V49.723h36.585v15.261z" fill="#000001" data-color="1"></path>
            ...
            <div style="display:inline-block;margin-right:80px">
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="30.57 30.57 138.86 138.86"
             viewBox="30.57 30.57 138.86 138.86" height="30" width="30" xmlns="http://www.w3.org/2000/svg"
              data-type="color" role="presentation" aria-hidden="true"><defs><style>#comp-jpqo4bs4 svg [data-color="1"] {fill: #B2BECF;}</style></defs>
    <g>
        ...
        <path d="M87.175 112.825h-41.65v41.649h41.649v-41.649zm-8 33.65h-25.65v-25.649h25.649v25.649z" fill="#000001" data-color="1"></path>
            ...
            <div style="display:inline-block;margin-right:80px">
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="28.932 28.931 143.122 142.137"
             viewBox="28.932 28.931 143.122 142.137" height="30" width="30" xmlns="http://www.w3.org/2000/svg" 
             data-type="color" role="presentation" aria-hidden="true"><defs><style>#comp-jpqo4brf svg [data-color="1"] {fill: #B2BECF;}
             </style></defs>
    <g>
...
<svg preserveAspectRatio="xMidYMid meet" data-bbox="34.57 31.149 130.859 137.702" 
viewBox="34.57 31.149 130.859 137.702" height="30" width="30" xmlns="http://www.w3.org/2000/svg" data-type="color"
 role="presentation" aria-hidden="true"><defs><style>#comp-jpr06hah svg [data-color="1"] {fill: #B2BECF;}</style></defs>
    <g>
...
<div>
    ...
    <div style="display:inline;margin-right:45px;"><input type="radio" value="West Side" 
    name="propertyradio" style="margin-right:10px" checked>West Side</div>
 <div style="padding-top:2rem">
