...
<header>
    ...
    <section style="max-width:70%;margin-left:15%">
       <div class="head">
        <h1 style="font-size:40px;margin-bottom:3%;padding-top: 1rem;">The Skyside</h1>
       </div>
       <div>
        <span style="color:red;font-size:22px">33,20,000 INR</span>
       </div>
       <div style="padding-top:2rem">
        <img src="img/i3.jpg" height="600px" style="border-radius:2rem 2rem 2rem 2rem">
       </div>
      ...
      <div style="width:60%;coolor:2B2B2B;;padding-top:1.5rem;font-size:15px;justify:content">
        <p>It is a two-bedroom, two-bathroom house. It is typically the smallest type of house,
             but it is still a comfortable and spacious home for a small family 
             or a couple. The bedrooms are typically of a good size, 
...
<div>
    ...
    <div style="display:inline;margin-right:45px;"><input type="radio" value="The Skyside" name="propertyradio" style="margin-right:10px" checked>The Skyside</div>
