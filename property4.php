...
<header>
    ...
    <section style="max-width:70%;margin-left:15%">
       <div class="head">
        <h1 style="font-size:40px;margin-bottom:3%;padding-top: 1rem;">Prestige Valley</h1>
       </div>
       <div>
        <span style="color:red;font-size:22px">20,00,000 INR</span>
       </div>
       <div style="padding-top:2rem">
        <img src="img/i4.jpg" height="600px" style="border-radius:2rem 2rem 2rem 2rem">
       </div>
      ...
      <div style="width:60%;coolor:2B2B2B;;padding-top:1.5rem;font-size:15px;justify:content">
        <p>The house features five spacious bedrooms, each designed with comfort and style in mind. There
             are three beautifully designed bathrooms in the Prestige Valley house. These bathrooms are equipped with modern fixtures, 
            including bathtubs and showers, providing both convenience and a touch of luxury. In addition to the bedrooms and bathrooms, Prestige Valley also offers
             a range of inviting living spaces. The open-concept living room is perfect for gatherings and entertainment, featuring high ceilings and large windows that 
             provide picturesque views of the surroundings. 
        </p>
...
<div>
    ...
    <div style="display:inline;margin-right:45px;"><input type="radio" value="Prestige Valley" name="propertyradio" style="margin-right:10px" checked>Prestige Valley</div>
