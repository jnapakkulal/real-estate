...
<header>
    ...
    <section style="max-width:70%;margin-left:15%">
       <div class="head">
        <h1 style="font-size:40px;margin-bottom:3%;padding-top: 1rem;">Marian Park</h1>
       </div>
       <div>
        <span style="color:red;font-size:22px">17,00,000 INR</span>
       </div>
       <div style="padding-top:2rem">
        <img src="img/i5.jpg" height="600px" style="border-radius:2rem 2rem 2rem 2rem">
       </div>
      ...
      <div style="width:60%;coolor:2B2B2B;;padding-top:1.5rem;font-size:15px;justify:content">
        <p>Marian Park is a charming 3-bedroom house that exudes a cozy and welcoming ambiance. 
            With two well-appointed bathrooms and a thoughtful design,
             it's a perfect choice for a small family or individuals looking for a comfortable and functional living space.
             The design of Marian Park is a perfect blend of functionality and aesthetics. Here are some key design elements:
...
<div>
    ...
    <div style="display:inline;margin-right:45px;"><input type="radio" value="Marian Park" name="propertyradio" style="margin-right:10px" checked>Marian Park</div>
