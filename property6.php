...
<header>
    ...
    <section style="max-width:70%;margin-left:15%">
       <div class="head">
        <h1 style="font-size:40px;margin-bottom:3%;padding-top: 1rem;">Inland Pacific</h1>
       </div>
       <div>
        <span style="color:red;font-size:22px">45,20,000 INR</span>
       </div>
       <div style="padding-top:2rem">
        <img src="img/i10.jpg" height="600px" style="border-radius:2rem 2rem 2rem 2rem">
       </div>
      ...
      <div style="width:60%;coolor:2B2B2B;;padding-top:1.5rem;font-size:15px;justify:content">
        <p>
The Inland Pacific House in Bondel is a spacious and functional 4-bedroom home with 2 bathrooms. This charming residence 
is designed to cater to the needs of a family or individuals seeking comfort and convenience.
The house boasts four generously sized bedrooms, each with its own unique charm. These bedrooms provide 
...
<div>
    ...
    <div style="display:inline;margin-right:45px;"><input type="radio" value="Inland Pacific" name="propertyradio" style="margin-right:10px" checked>Inland Pacific</div>
